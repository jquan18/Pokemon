...
public class register extends JFrame {
    ...
    public register(Intro parent, Dimension size) {
        ...
        submitButton.addActionListener(e -> {
            ...
            // Check if username and password fields are not blank
            if (username.trim().isEmpty() || password.trim().isEmpty() || confirmPassword.trim().isEmpty()) {
                JOptionPane.showMessageDialog(register.this, "Username and password fields cannot be blank.", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
